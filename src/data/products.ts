...
export const initialProductData: ProductSeedData[] = [
  ...
  { name: 'ATÚN', description: `${PIZZA_BASE_DESCRIPTION}, atún, pimiento rojo y cebolla.`, price: 10.00, category: 'Pizzas', imageUrl: DEFAULT_FOOD_IMAGE, dataAiHint: 'atun pizza', allergens: [...COMMON_PIZZA_ALLERGENS, 'pescado'] },
  { name: 'BARBACOA', description: `${PIZZA_BASE_DESCRIPTION}, carne picada con salsa barbacoa.`, price: 10.00, category: 'Pizzas', imageUrl: DEFAULT_FOOD_IMAGE, dataAiHint: 'barbacoa pizza', allergens: [...COMMON_PIZZA_ALLERGENS, 'mostaza', 'soja', 'apio'] }, // Salsa BBQ y carne picada
  ...
  { name: 'BACON', description: `${PIZZA_BASE_DESCRIPTION}, bacon, huevo y pimiento rojo.`, price: 10.00, category: 'Pizzas', imageUrl: DEFAULT_FOOD_IMAGE, dataAiHint: 'bacon pizza', allergens: [...COMMON_PIZZA_ALLERGENS, 'huevos'] },
